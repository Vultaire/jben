...
/* DEVNOTE: This code just got redone with a multi-level wxNotebook layout.
   The code needs to be updated to raise events on the child notebooks and have those events properly handled.
